...
{
    public override string DisplayName => "PMDG 73X";
    ...
    {
        if (_vars.WheelChocks >= 0.5 && _vars.Gpu > 0.5)
        {
            Logger.Debug("Pmdg737Adapter: Chocks and GPU already Set - skipping CDU Sequence");
            return;
        }
